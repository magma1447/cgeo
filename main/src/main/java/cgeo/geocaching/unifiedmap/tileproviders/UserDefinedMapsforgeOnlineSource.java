...
public class UserDefinedMapsforgeOnlineSource extends AbstractMapsforgeOnlineTileProvider {
    ...
    UserDefinedMapsforgeOnlineSource(final Settings.PrefUserDefinedTileProvider provider) {
        super(UserDefinedTileProviderHelper.getName(provider), Uri.parse(provider.getUri()), "/{Z}/{X}/{Y}.png", 2, 18, new Pair<>(UserDefinedTileProviderHelper.getName(provider), true));
