...
import cgeo.geocaching.unifiedmap.tileproviders.UserDefinedTileProviderHelper;
...
public class PreferenceMapSourcesFragment extends BasePreferenceFragment {
    ...
    private Preference createUserDefinedTileProviderPreferenceAddNew() {
        ...
        preference.setSummary(R.string.settings_userDefinedTileProviderUri);
        preference.setLayoutResource(R.layout.preference_button);
        preference.setIconSpaceReserved(false);
        preference.setOnPreferenceClickListener(pref -> {
            createUserDefinedTileProviderPreference(new Settings.PrefUserDefinedTileProvider(randomUUID().toString(), "", "")).launchEditDialog();
            return true;
        });
        return preference;
    }

    private UserDefinedTileProviderPreference createUserDefinedTileProviderPreference(final Settings.PrefUserDefinedTileProvider provider) {
        ...
        preference.setTitle(UserDefinedTileProviderHelper.getName(provider));
